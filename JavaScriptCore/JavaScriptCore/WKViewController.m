...
- (void)viewDidLoad {
    ...
    NSURL *path = [[NSBundle mainBundle] URLForResource:@"html/test" withExtension:@"html"];
...
- (void)userContentController:(WKUserContentController *)userContentController
    ...
    if ([message.name isEqualToString:@"AppModel"]) {
        ...
        if ([message.body objectForKey:@"push"] != nil) {
            NSString *num = [[NSString alloc] initWithString:[message.body objectForKey:@"push"]];
            DetailsViewController *vc = [[DetailsViewController alloc] init];
            vc.name = message.body;
            vc.age = num;
